...
namespace PetaPoco
{
    ...
    public static class DatabaseExtensions
    {
        ...
        {
            return Task.Factory.StartNew(() => alertPoco.Insert(tableName, poco));
        }
        public static Task<object> InsertAsync(this IAlterPoco alertPoco, string tableName, string primaryKeyName, object poco)
        {
            return Task.Factory.StartNew(() => alertPoco.Insert(tableName, primaryKeyName, poco));
        }
        ...
        {
            return Task.Factory.StartNew(() => alertPoco.Insert(tableName, primaryKeyName, autoIncrement, poco));
        }
        public static Task<object> InsertAsync(this IAlterPoco alertPoco, object poco)
        {
            return Task.Factory.StartNew(() => alertPoco.Insert(poco));
        }
        ...
        {
            return Task.Factory.StartNew(() => alertPoco.Update(tableName, primaryKeyName, poco, primaryKeyValue));
        }
        ...
        {
            return Task.Factory.StartNew(() => alertPoco.Update(tableName, primaryKeyName, poco, primaryKeyValue, columns));
        }
        public static Task<int> UpdateAsync(this IAlterPoco alertPoco, string tableName, string primaryKeyName, object poco)
        {
            return Task.Factory.StartNew(() => alertPoco.Update(tableName, primaryKeyName, poco));
        }
        ...
        {
            return Task.Factory.StartNew(() => query.Query<T>(sql, args));
        }
        public static Task<IEnumerable<T>> QueryAsync<T>(this IQuery query, Sql sql)
        {
            return Task.Factory.StartNew(() => query.Query<T>(sql));
        }
        ...
        {
            return Task.Factory.StartNew(() => query.Query(cb, sql, args));
        }
        ...
        {
            return Task.Factory.StartNew(() => query.Query(cb, sql));
        }
        ...
        {
            return Task.Factory.StartNew(() => query.Fetch(cb, sql));
        }
