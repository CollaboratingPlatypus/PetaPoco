...
{
    /// <summary>
    /// Wraps a <see cref="DateTime"/> that will be stored in the DB as a <see cref="System.Data.DbType.DateTime2"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <para/><see cref="System.Data.DbType.DateTime2">DbType.DateTime2</see> is a data type used by SQL DBs with a larger date range and fractional second precision than <see cref="System.Data.DbType.DateTime">DbType.DateTime</see>.
    /// </remarks>
    public class DateTime2
    {
        ...
        /// </summary>
        /// <param name="value">The DateTime to be converted for storage in the DB.</param>
        ...
        /// <returns>A <see cref="DateTime2"/> instance containing the converted <see cref="DateTime"/>.</returns>
