...
namespace PetaPoco.Providers
{
    ...
    /// <summary>
    /// The SqlServerCEDatabaseProviders class provides a specific implementation of the <see cref="DatabaseProvider"/> class for the SQL Server Compact Edition database.
    /// </summary>
