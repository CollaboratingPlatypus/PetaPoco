...
namespace PetaPoco
{
    ...
    public interface IAlterPoco
    {
        ...
        /// <summary>
        /// Updates the specified columns of a record with the given ID in the provided table and returns the number of rows affected by the update operation.
        /// </summary>
        ...
        /// <remarks>
        /// A POCO instance is considered "new" if the <paramref name="poco"/> property that maps to the associated table's primary key column contains a default value.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// A POCO instance is considered "new" if the <paramref name="poco"/> property that maps to the associated table's provided column name contains a default value.
        /// </remarks>
        /// <param name="primaryKeyName">The table's primary key column name.</param>
