...
namespace PetaPoco.Tests.Integration.Databases.MSAccess
{
    ...
    public class MSAccessPreExecuteTests : PreExecuteTests
    {
        ...
        protected class PreExecuteDatabaseProvider : PetaPoco.Providers.MsAccessDbDatabaseProvider, IPreExecuteDatabaseProvider
        {
