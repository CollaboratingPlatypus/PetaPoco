...
namespace PetaPoco.Tests.Integration.Databases.Sqlite
{
    public class SqliteDBTestProvider : DBTestProvider
    {
...
#else
        //protected override IDatabase Database => CreateConfiguration("SQLite");
        protected override IDatabase Database => CreateConfiguration("SQLite").UsingDefaultMapper<ConventionMapper>(m =>
        {
            m.FromDbConverter = (targetProperty, sourceType) =>
            {
                if (targetProperty != null && sourceType == typeof(long))
        ...
        protected override string ScriptResourceName => @"Scripts\SqliteBuildDatabase.sql";
    }
}